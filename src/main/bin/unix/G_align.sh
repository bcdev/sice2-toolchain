...
# compression does not seem to work that way, generated images cannot be read by SNAP and other viewers
#tifopts='type=Float32 createopt=TILED=YES --q --o'  # works!
tifopts='type=Float32 createopt=COMPRESS=DEFLATE,PREDICTOR=3,TILED=YES --q --o'
